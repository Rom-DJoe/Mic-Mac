...
for(m=0;m<Filelist.length;m++)
		...
		if (endsWith(name, "nd") || endsWith(name, "ND"))
			{
			if (endsWith(name, "nd"))
				{
				nameW = replace(name,".nd","");
				ndfile = 1;
				}
			else if (endsWith(name, "ND"))
				{
				nameW = replace(name,".ND","");
				ndfile = 1;
				}
		...
		else if (endsWith(name, "tif") || endsWith(name, "TIF"))
			{
			if (ndfile == 0)
				{
				
// When first picture ends with -1dic.tif, bypass the "type the name of the acquisition" step
				if (endsWith(name, "-1dic.tif"))
					{
			nameW = replace(name,"-1dic.tif","");
					}
				else
					{
